...
$sql = "SELECT * FROM employees"; // Adjust the query as needed
...
<head>
    ...
    <style>
        ...
        .user-list-container {
            ...
            gap: 20px; /* Add space between the employee containers */
            margin: 20px;
        }
        ...
        .user-container {
            ...
            display: flex;
            flex-direction: column; /* Keep the user data in a vertical layout */
            justify-content: space-between;
        }

        .user-container:hover {
            background-color: #4B6B7A; /* Darker blue on hover */
        }
        ...
        .user-container h4 {
            ...
            font-weight: bold;
            padding-bottom: 8px;
            border-bottom: 2px solid #fff; /* Dividing line for clarity */
        }
