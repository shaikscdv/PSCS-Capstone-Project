...
// Fetch users from the database including the new fields
            ...
            <?php if (count($users) > 0): ?>
                <?php foreach ($users as $user): ?>
                    <div class="user-container">
                        <h4><?php echo htmlspecialchars($user['store_name']); ?></h4>
                       
                        <p><strong>Email:</strong> <?php echo htmlspecialchars($user['email']); ?></p>
                        <p><strong>emergency_question:</strong> <?php echo htmlspecialchars($user['emergency_question']); ?></p>
                        <p><strong>emergency_answer:</strong> <?php echo htmlspecialchars($user['emergency_answer']); ?></p>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <p>No users found.</p>
