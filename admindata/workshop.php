...
$sql = "SELECT * FROM  registrations1";
            ...
            <?php if (count($blog_posts ) > 0): ?>
                <?php foreach ($blog_posts  as $user): ?>
                    <div class="user-container">
                        ...
                        <p><strong>Members:</strong> <?php echo htmlspecialchars($user['num_members']); ?></p>
                        <p><strong>workshop_type :</strong> <?php echo htmlspecialchars($user['workshop_type']); ?></p>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <p>No users found.</p>
