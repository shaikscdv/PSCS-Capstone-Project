...
<div class="container">
    ...
    <div class="sidebar">
        <h2>Dashboard</h2>
         <!-- Link to Cart Items -->
        <a href="emark.php" class="sidebar-link"> Marketing and Advertising</a> <!-- Link to Purchased Items -->
        <a href="efinan.php" class="sidebar-link">Finance and Accounting</a> <!-- Link to New Offers -->
        <a href="esales.php" class="sidebar-link">Sales and Business Development</a> <!-- Link to Blogs -->
        <a href="edata.php" class="sidebar-link">Data Analytics and Reporting</a> 
        <a href="errordetails.php" class="sidebar-link">Error Messages Details </a><!-- Link to Add Blog -->
    </div>
    ...
    <div class="main-content">
        <div class="dashboard-container">
            ...
            <p class="name"><img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" class="img1"/><b>Hello</b>, <?php echo $user['employee_name']; ?></p>
