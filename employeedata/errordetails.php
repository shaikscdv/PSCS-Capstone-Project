            ...
            <?php if (count($blog_posts ) > 0): ?>
                <?php foreach ($blog_posts  as $user): ?>
                    <div class="user-container">
                        <h4><?php echo htmlspecialchars($user['error_title']); ?></h4>
                        <p><strong>date:</strong> <?php echo htmlspecialchars($user['error_date']); ?></p>
                        <p><strong>Message:</strong> <?php echo htmlspecialchars($user['error_message']); ?></p>
