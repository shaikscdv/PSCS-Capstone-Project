...
$sql = "SELECT * FROM  sales_and_business_development";
...
<body>
    ...
    <div>
        <h3>sales_and_business_development List</h3>
            ...
            <?php if (count($blog_posts ) > 0): ?>
                <?php foreach ($blog_posts  as $user): ?>
                    <div class="user-container">
                        <h4><?php echo htmlspecialchars($user['client_name']); ?></h4>
                        <p><strong>deal value:</strong> <?php echo htmlspecialchars($user['deal_value']); ?></p>
                        <p><strong>date:</strong> <?php echo htmlspecialchars($user['transaction_date']); ?></p>
