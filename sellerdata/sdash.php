...
<div class="container">
    ...
    <div class="sidebar">
        <h2>Dashboard</h2>
        <a href="index.php" class="sidebar-link">Add Products</a> <!-- Link to Products -->
        
        <a href="snewoffers.php" class="sidebar-link">New Offers</a> <!-- Link to New Offers -->
        <a href="sblog.php" class="sidebar-link">Blogs</a> <!-- Link to Blogs -->
        <a href="sblogadd.php" class="sidebar-link">Add Blog</a> <!-- Link to A
        dd Blog -->
    </div>
    ...
    <div class="main-content">
        <div class="dashboard-container">
            ...
            <p class="name"><img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" class="img1"/><b>Hello</b>, <?php echo $user['store_name']; ?></p>
