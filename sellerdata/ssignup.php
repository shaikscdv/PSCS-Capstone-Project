...
$dbname = "finalyear"; // Database name
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO sellers (store_name, email, password, emergency_question, emergency_answer) 
            VALUES ('$store_name', '$email', '$password', '$emergency_question', '$emergency_answer')";

    if ($conn->query($sql) === TRUE) {
        header("Location:slogin.php"); // Redirect to sign in page after successful registration
    } else {
