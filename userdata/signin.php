...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['forgot_password'])) {
        ...
        $sql = "SELECT emergency_question FROM users WHERE email = '$email'";
    ...
    // Handle the case when the user submits the emergency question
    if (isset($_POST['emergency_answer'])) {
        $email = $_POST['username'];
        $emergency_answer = $_POST['emergency_answer'];

        // Check if the emergency answer is correct
        $sql = "SELECT * FROM users WHERE email = '$email' AND emergency_answer = '$emergency_answer'";
        $result = $conn->query($sql);
...
<div class="body1">
    <div class="form-container">
        ...
        <div class="form-footer">
            ...
            <p>New to CraftCove? <a href="signup.php">Sign up</a></p>
        </div>
    </div>
</div>
